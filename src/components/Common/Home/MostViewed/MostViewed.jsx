...
const MostViewed = () => {
    ...
    const { isPending, isError, error, data } = useQuery({
        ...
        queryFn: async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_PATH}/products/get-all?sortBy=-view&is_published=true&draft=false`)
    ...
    return (
        <div className='mt-6 pb-10 font-main relative' dir={currentLanguage == 'ar' && 'rtl'} >
            ...
            <div className='flex gap-2 items-center'>
                ...
                <p className='text-[20px] font-[600] text-secondary-color '>{t('titles.most_viewed')}</p>
            </div>
            {
